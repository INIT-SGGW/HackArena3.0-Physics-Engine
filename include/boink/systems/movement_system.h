...
class MovementSystem {
 public:
  ...
  void Update(ComponentManager<TupleStaticComponents_, TupleComponents_>&
    ...
    view.forEach([&, dt](const CarInput& input, Transform& trans,
                         Kinematics& kin) {
      ...
      Matrix3d delta_rotation =
          math::getRotationMatrix(model.direction, new_model_direction);
